...
mod tests {
    ...
    /// → controller picks Mode 3 (Prometheus archive) because HLL
    ...
    /// HLL → controller picks Mode 1 (HLL at edge wins now). Raw cost
    ...
    /// Snapshot scenario at 1 Hz × 60 s × 5 K cardinality (controller
