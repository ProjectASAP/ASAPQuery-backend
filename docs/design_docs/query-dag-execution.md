...
and query/precompute bindings. ASAPPlanner #462 owns `physical_planner`, native
...
instantiates the selected graph. PromQL vector and maintenance adapters continue
