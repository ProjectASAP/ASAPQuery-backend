...
pub struct SnapshotEntry {
    ...
    pub start_ts: u64,
    pub end_ts: u64,
    pub label: Option<crate::data_model::KeyByLabelValues>,
...
impl PartReader {
    ...
    pub fn load_entry(&self, rec: &IndexRecord) -> PersistResult<SnapshotEntry> {
        ...
        let label = if label_len == 0 {
            ...
            Some(
                crate::data_model::KeyByLabelValues::deserialize_from_bytes(label_bytes)
...
mod tests {
    ...
    use crate::stores::simple_map_store::persistence::source::EpochSnapshotEntry;
