...
mod tests {
    use super::*;
    use crate::data_model::{AggregationType, CleanupPolicy, LockStrategy, StreamingConfig};
    ...
    fn write_one(store: &SimpleMapStore, agg_id: u64, ts: u64) {
        ...
        let output = crate::data_model::PrecomputedOutput::new(ts, ts + 1000, None, agg_id);
        store
