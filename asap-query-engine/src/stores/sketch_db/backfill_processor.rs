...
use crate::data_model::{AggregateCore, HotReloadStreamingConfig, KeyByLabelValues};
...
impl WindowProcessor for BackfillWindowProcessor {
    async fn process_window(
        ...
        let mut batch: Vec<(crate::data_model::PrecomputedOutput, Box<dyn AggregateCore>)> =
