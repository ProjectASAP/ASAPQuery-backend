...
use query_engine_rust::utils::file_io::read_inference_config;
use query_engine_rust::AggregateCore;
...
fn rate_routes_to_increase_accumulator_warm_tier() {
    ...
    let acc = IncreaseAccumulator::new(
        query_engine_rust::Measurement::new(0.0),
        0,
        query_engine_rust::Measurement::new(100.0),
        60_000,
    );
    let engine = build_engine(
        "fake_metric",
...
fn increase_routes_to_increase_accumulator_warm_tier() {
    let acc = IncreaseAccumulator::new(
        query_engine_rust::Measurement::new(5.0),
        0,
        query_engine_rust::Measurement::new(25.0),
        60_000,
    );
    let engine = build_engine(
        "fake_metric",
