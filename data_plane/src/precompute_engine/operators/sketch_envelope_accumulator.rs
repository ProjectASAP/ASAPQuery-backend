...
use crate::stores::types::{AggregateCore, KeyByLabelValues, SerializableToSink};
...
impl crate::stores::types::MultipleSubpopulationAggregate for SketchEnvelopeAccumulator {
    fn query(
        &self,
        _statistic: Statistic,
    ...
    fn clone_boxed(&self) -> Box<dyn crate::stores::types::MultipleSubpopulationAggregate> {
        Box::new(self.clone())
    }
}
