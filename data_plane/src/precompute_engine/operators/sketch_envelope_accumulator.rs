...
use crate::stores::schema::{AggregateCore, KeyByLabelValues, SerializableToSink};
...
impl crate::stores::schema::MultipleSubpopulationAggregate for SketchEnvelopeAccumulator {
    fn query(
        &self,
        _statistic: Statistic,
    ...
    fn clone_boxed(&self) -> Box<dyn crate::stores::schema::MultipleSubpopulationAggregate> {
        Box::new(self.clone())
    }
}
