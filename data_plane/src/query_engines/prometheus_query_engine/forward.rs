...
//!   registered in the [`crate::query_engines::routing::EngineRouter`] under id
...
//!
//! This is a near-mirror of [`crate::query_engines::thanos_query_engine::forward`]
...
mod tests {
    ...
    use crate::query_engines::routing::query_engine_routing::{EngineRouter, QueryEngine as RouterQueryEngine};
    use std::sync::Arc;
