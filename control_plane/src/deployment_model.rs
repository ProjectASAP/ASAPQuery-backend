...
//!
//! A deployment model bundles the control-plane-side knowledge that
...
//!
//! Per `control_plane/docs/design.md` §5, the long-term plan is one Cargo
...
impl DeploymentModelId {
    /// Default DC deployment id — the control plane's historical name for
